...
//                    mLogView.logI("Join channel success, uid: " + (uid & 0xFFFFFFFFL));
                    Log.i("提示信息：","Join channel success, uid: " + (uid & 0xFFFFFFFFL));
                }
            });
        }
...
//                    mLogView.logI("First remote video decoded, uid: " + (uid & 0xFFFFFFFFL));
                    Log.i("提示信息：","First remote video decoded, uid: " + (uid & 0xFFFFFFFFL));
...
//                    mLogView.logI("User offline, uid: " + (uid & 0xFFFFFFFFL));
                    Log.i("提示信息：","User offline, uid: " + (uid & 0xFFFFFFFFL));
    ...
    private void showSampleLogs() {
        Log.i("提示信息：","这里演示的是LoggerRecyclerView的使用实例");
...
//            mRtcEngine = RtcEngine.create(getBaseContext(), getString(R.string.agora_app_id), mRtcEventHandler);
            ...
            String agora_app_id = MyApp.getRtcEngineConfigJsonBean().getData().getApp_id();
...
//        String token = getString(R.string.agora_access_token);
        String token = MyApp.getRtcEngineConfigJsonBean().getData().getAccess_token();
        String channelName = MyApp.getRtcEngineConfigJsonBean().getData().getChannel_name();
...
//        mRtcEngine.joinChannel(token, "demoChannel1", "Extra Optional Data", 0);
    ...
    public void onCallClicked(View view) {
        if (mCallEnd) {
            ...
            endCall();
            // region 李森 修改 20230710
//            mCallEnd = true;
//            mCallBtn.setImageResource(R.drawable.btn_startcall);
            // endregion 李森 修改 20230710
            finish();
        }
