...
public class DemoDialog extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getTag().toString()) {
            ...
            case "btn_dialog_one":
                ...
                alert = builder.setIcon(R.mipmap.home_icon_xiaoxi)
                        .setTitle("系统提示：")
